...
public class RoverSciencePagerFragment extends Fragment {
    private final static String TAG = RoverSciencePagerFragment.class.getSimpleName();
  ...
  /*          int scienceIndex = bundle.getInt(HelperUtils.SCIENCE_INDEX_PAGER_EXTRA);
            int scienceImageId = bundle.getInt(HelperUtils.SCIENCE_IMAGE_ID_EXTRA);*/
